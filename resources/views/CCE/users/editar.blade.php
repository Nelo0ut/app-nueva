        ...
        <!-- left column -->
          <div class="col-12 col-md-6">
            ...
            <div class="card card-morado">
              ...
              <!-- /.card-header -->
              <!-- form start -->
                <form action="{{ route('user.update', $user->id) }}" method="POST" role="form" id="quickForm" class="needs-validation" novalidate>
                    <div class="card-body">
                      <input type="hidden" name="iduser" id="iduser" value="{{$user->id}}">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="usuario" class="form-control " id="usuario" placeholder="Ingresar el usuario" maxlength="15" minlength="5" required value="{{ old('usuario', $user->usuario) }}">
                        </div>
                        <div class="form-group">
