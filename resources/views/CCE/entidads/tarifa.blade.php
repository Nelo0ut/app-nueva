        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form action="{{ route('filtar-tarifa') }}" method="POST" role="form" id="quickForm" class="needs-validation" novalidate>
                                @csrf
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <select class="form-control select2 select2-purple" data-dropdown-css-class="select2-purple" style="width: 100%;"
                                            required id="entidad_id" name="entidad_id">
                                            <option value="">:: Seleccione ::</option>
                                            @foreach ($entidads as $entidad)
                                            <option value="{{ $entidad->id }}" {{ old('entidad_id') == $entidad->id ? 'selected' : '' }}>{{ $entidad->alias }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group col-md-3">
                                    ...
                                    <div class="form-group col-md-2">
                                        <label for=""></label>
                                        <button type="submit" class="btn btn-morado btn-block">Filtrar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="row">
                        ...
                        @endif
                        <div class="col-md-3 mb-3">
                            <button class="btn btn-info btn-sm abrirmodalTIN" data-tipo="{{$tarifas[0]->tipotarifa}}" data-id="{{$tarifas[0]->entidad_id}}">Configurar TIN
                                Especial</button>
                        </div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    @if ($oldre['moneda'] == null)
                                        @if ($oldre['tipo'] == null)
                                            ...
                                            @if ($tarifas[$i]->tipoplaza==1)
                                                <td colspan="3" align="center">S/. {{ $oldre['tipotransferencia'] > 0 ? $tarifas[$i]->sol_cci_montofijo : 0 }}</td>
                                            @else
                                            ...
                                            @if ($tarifas[$i]->tipoplaza==1)
                                                <td colspan="3" align="center">$ {{ $oldre['tipotransferencia'] > 0 ? $tarifas[$i]->dol_cci_montofijo : 0 }}</td>
                    ...
                    @if ($oldre['tipotransferencia'] > 0)
                        @if ($tarifas[0]->tipotarifa > 0)
                            ...
                            @endphp
                            <a href="{{route('editar_tarifa_entidad', ['tarifa'=> $tarifa_get, 'tipotransferencia'=> $tipotrans_get, 'tipo' => $tipo_get ])}}" class="btn btn-morado">Modificar Tarifa</a>
                        @endif
                    @endif
                    @else
                        <hr>
