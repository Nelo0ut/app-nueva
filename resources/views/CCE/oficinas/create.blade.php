...
@section('content')
    ...
    <section class="content">
      <form action="{{ route('oficina.store') }}" method="post" autocomplete="off" role="form" id="quickForm" class="needs-validation" novalidate>
        @csrf
        <div class="row">
          <div class="col-md-6">
            <div class="card card-naranja">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="name" name="name" class="form-control" maxlength="35" required value="{{ old('name') }}">
                </div>
                <div class="form-group">
                  <label for="numero">Número de oficina *</label>
                  <input type="text" id="numero" name="numero" class="form-control valnumero" maxlength="3" required value="{{ old('numero') }}">
                </div>
                <div class="form-group">
                  <label for="domicilio">Domicilio *</label>
                  <input type="text" id="domicilio" name="domicilio" class="form-control" maxlength="80" required value="{{ old('domicilio') }}">
                </div>
                <div class="form-group">
                  <label for="localidad">Localidad *</label>
                  <input type="text" id="localidad" name="localidad" class="form-control" maxlength="35" required value="{{ old('localidad') }}">
                </div>
                <div class="form-group">
                  <label for="nameplaza">Nombre de la Plaza *</label>
                  <input type="text" id="nameplaza" name="nameplaza" class="form-control" maxlength="35" required value="{{ old('nameplaza') }}">
                </div>
                <div class="form-group">
                  <label for="numeroplaza">Número de oficina en la Plaza *</label>
                  <input type="text" id="numeroplaza" name="numeroplaza" class="form-control valnumero" maxlength="4" required value="{{ old('numeroplaza') }}">
                </div>
                <div class="form-group">
                  ...
                  <select class="form-control custom-select" name="tipooficina_id" id="tipooficina_id" required>
                    ...
                    @foreach ($tipooficinas as $tipooficina)
                      <option value="{{ $tipooficina->id }}">{{ $tipooficina->name }}</option>
                    @endforeach
                  </select>
                </div>
                <div class="form-group">
                  <label for="preftelefono">Prefijo de teléfono larga distancia</label>
                  <input type="text" id="preftelefono" name="preftelefono" maxlength="3" class="form-control valnumero" value="{{ old('preftelefono') }}">
                </div>
                <div class="form-group">
                  <label for="telefono1">Número telefónico 1</label>
                  <input type="text" id="telefono1" name="telefono1" maxlength="8" class="form-control valnumero" value="{{ old('telefono1') }}">
                </div>
                <div class="form-group">
                  <label for="telefono2">Número telefónico 2</label>
                  <input type="text" id="telefono2" name="telefono2" maxlength="8" class="form-control valnumero" value="{{ old('telefono2') }}">
                </div>
                <div class="form-group">
                  <label for="fax">FAX</label>
                  <input type="text" id="fax" name="fax" maxlength="8" class="form-control valnumero" value="{{ old('fax') }}">
                </div>
                <div class="form-group">
                  <label for="centraltelefonica">Central telefónica</label>
                  <input type="text" id="centraltelefonica" name="centraltelefonica" maxlength="8" class="form-control valnumero" value="{{ old('centraltelefonica') }}">
                </div>
                <div class="form-group">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <button type="submit" class="btn btn-morado">Agregar oficina</button>
          </div>
        </div>
      </form>
    </section>
