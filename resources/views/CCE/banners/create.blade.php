...
<section class="content">
    <form action="{{ route('banner.store') }}" method="POST" role="form" id="quickForm" class="needs-validation" enctype="multipart/form-data"
        novalidate>
        @csrf
        <div class="row">
            <!-- left column -->
                ...
                <div class="card card-morado">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" name="banners" id="banners" required
                                        accept=".jpeg,.jpg,.png">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="titulo" name="titulo" class="form-control" value="" placeholder="Ingrese el título">
                        </div>
                        <div class="form-group">
                            <label for="subtitulo">Subtitulo *</label>
                            <input type="text" id="subtitulo" name="subtitulo" class="form-control" value=""
