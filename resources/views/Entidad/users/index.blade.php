                        ...
                        <tr>
                            ...
                            @if(auth()->user()->role_id == 3)
                              <td>
                                ...
                                <a href="{{ route('usuario-ver', $user->id) }}" class="btn btn-app btnEdit">
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <!-- form start -->
                <form action="{{ route('usuario-guardar') }}" method="POST" role="form" id="quickForm" class="needs-validation" novalidate>
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="usuario" class="form-control" id="usuario" placeholder="Ingresar el usuario" maxlength="15"
...
<script>
  ...
  $(function () {
    ...
    $('#usuario').blur(function() {
        ...
        $.ajax({
            type:'POST',
            url:"{{ route('getusuariouserentidad') }}",
