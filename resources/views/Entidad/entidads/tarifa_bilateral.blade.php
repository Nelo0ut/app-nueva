        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form action="{{ route('entidad_filtar_tarifa_bilateral') }}" method="POST" role="form" id="quickForm" class="needs-validation" novalidate>
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3 pt-4">
                                        ...
                                        <a href="{{route('entidad_ver_crear_tarifa')}}" class="btn btn-morado mt-2">Nueva Tarifa Bilateral</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    @if($tarifatotal)
                        ...
                        @for ($i = 0; $i < count($tarifatotal); $i++)
                            ...
                            <div class="col-md-12 mt-3">
                                <a href="{{route('entidad_eliminar_tarifa', ['mp'=>$mp,'op'=>$op,'pe'=>$pe])}}" class="btn btn-morado mr-2">Eliminar Tarifa</a>
                                <a href="{{route('entidad_ver_tarifa', ['mp'=>$mp,'op'=>$op,'pe'=>$pe])}}" class="btn btn-morado">Modificar Tarifa</a>
                            </div>
                            <hr>
                        @endfor                        
                    @else
