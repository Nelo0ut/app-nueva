    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-body" style="overflow-x: scroll">
                <form action="{{route('entidad_post_crear_tarifa')}}" method="POST" role="form" id="modificar" class="needs-validation"
                    novalidate>
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div class="form-row">
                                <input type="hidden" value="99999" name="entidad1_id" id="entidad1_id">
                    ...
                    <table id="example3" class="table nowrap" style="text-align: center">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <input type="number" min="0" class="form-control" name="mp_sol_montofijomin" id="mp_sol_montofijomin" value="{{old('mp_sol_montofijomin')}}" required>
                                    </td>
                                    <td colspan="3">
                                        <input type="number" min="0" class="form-control" name="mp_dol_montofijomin" id="mp_dol_montofijomin" value="{{old('mp_dol_montofijomin')}}" required>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">
                                    ...
                                    <td>
                                        <input type="number" min="0" class="form-control valdecimal" name="op_sol_porcentaje" id="op_sol_porcentaje"
                                            value="{{old('op_sol_porcentaje')}}" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control valdecimal" name="op_sol_montofijomin" id="op_sol_montofijomin"
                                            value="{{old('op_sol_montofijomin')}}" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control valdecimal" name="op_sol_montofijomax" id="op_sol_montofijomax"
                                            value="{{old('op_sol_montofijomax')}}" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control valdecimal" name="op_dol_porcentaje" id="op_dol_porcentaje"
                                            value="{{old('op_dol_porcentaje')}}" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control valdecimal" name="op_dol_montofijomin" id="op_dol_montofijomin"
                                            value="{{old('op_dol_montofijomin')}}" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control valdecimal" name="op_dol_montofijomax" id="op_dol_montofijomax"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" min="0" class="form-control valdecimal" name="pe_sol_porcentaje" id="pe_sol_porcentaje"
                                            value="{{old('pe_sol_porcentaje')}}" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control valdecimal" name="pe_sol_montofijomin" id="pe_sol_montofijomin"
                                            value="{{old('pe_sol_montofijomin')}}" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control valdecimal" name="pe_sol_montofijomax" id="pe_sol_montofijomax"
                                            value="{{old('pe_sol_montofijomax')}}" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control valdecimal" name="pe_dol_porcentaje" id="pe_dol_porcentaje"
                                            value="{{old('pe_dol_porcentaje')}}" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control valdecimal" name="pe_dol_montofijomin" id="pe_dol_montofijomin"
                                            value="{{old('pe_dol_montofijomin')}}" required>
                                    </td>
                                    <td>
                                        <input type="number" min="0" class="form-control valdecimal" name="pe_dol_montofijomax" id="pe_dol_montofijomax"
