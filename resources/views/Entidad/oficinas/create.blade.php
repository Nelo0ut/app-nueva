...
@section('content')
    ...
    <section class="content">
      <form action="{{ route('guardar-oficina') }}" method="post" autocomplete="off" role="form" id="quickForm" class="needs-validation" novalidate>
        @csrf
        <div class="row">
          <div class="col-md-6">
            <div class="card card-naranja">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="preftelefono" name="preftelefono" class="form-control valnumero" maxlength="3" value="{{ old('preftelefono') }}">
                </div>
                <div class="form-group">
                  <label for="telefono1">Número telefónico 1</label>
                  <input type="text" id="telefono1" name="telefono1" class="form-control valnumero" maxlength="8" value="{{ old('telefono1') }}">
                </div>
                <div class="form-group">
                  <label for="telefono2">Número telefónico 2</label>
                  <input type="text" id="telefono2" name="telefono2" class="form-control valnumero" maxlength="8" value="{{ old('telefono2') }}">
                </div>
                <div class="form-group">
                  <label for="fax">FAX</label>
                  <input type="text" id="fax" name="fax" class="form-control valnumero" maxlength="8" value="{{ old('fax') }}">
                </div>
                <div class="form-group">
                  <label for="centraltelefonica">Central telefónica</label>
                  <input type="text" id="centraltelefonica" name="centraltelefonica" class="form-control valnumero" maxlength="8" value="{{ old('centraltelefonica') }}">
                </div>
                <div class="form-group">
